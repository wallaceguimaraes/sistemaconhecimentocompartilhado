...
public class vwConhecimento {

	public JFrame frmconhecimento;
	...
	private void initialize() {
		frmconhecimento = new JFrame();
		frmconhecimento.addWindowListener(new WindowAdapter() {
			@Override
		...
		frmconhecimento.setResizable(false);
		...
		frmconhecimento.setTitle("Usu\u00E1rio: "+usu.getUsuario());
		frmconhecimento.getContentPane().setBackground(new Color(240, 255, 255));
		frmconhecimento.getContentPane().setLayout(null);

		Panel panel = new Panel();
		panel.setBackground(new Color(173, 216, 230));
		panel.setBounds(10, 10, 122, 552);
		frmconhecimento.getContentPane().add(panel);
		...
		Label lblConhecimento = new Label(regra.getRegra());
		lblConhecimento.setFont(new Font("Dialog", Font.BOLD | Font.ITALIC, 9));
		lblConhecimento.setBounds(0, 0, 107, 23);
		panelConhecimento.add(lblConhecimento);
		...
		frmconhecimento.getContentPane().add(panel_2);
		panel_2.setLayout(null);

		Label label_1 = new Label("Conhecimentos");
		...
		frmconhecimento.getContentPane().add(panel_1);
		...
		Label label_3 = new Label("Adicione novos conhecimentos");
		label_3.setFont(new Font("Dialog", Font.BOLD | Font.ITALIC, 10));
		label_3.setBounds(750, 47, 160, 22);
		panel_1.add(label_3);
		...
		labelBuscar.setBounds(335, 20, 28, 33);
		...
		frmconhecimento.getContentPane().add(panel_3);
...
//CONTROLADORES E MÉTODOS
	...
	preencheComboBox();
		...
		labelCancelar.setBounds(845, 22, 25, 25);
		...
		lbl_editar.setBounds(880, 22, 25, 25);
		...
		label_excluir.setBounds(915, 22, 25, 25);
		...
		labelBuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				conhecimentoDao.preencheBusca(textFieldTitulo.getText(),setor.getIdSetor());
				flag = 2;
				cct = null;
		...
		frmconhecimento.getContentPane().add(separator_1);
		JSeparator separator_2 = new JSeparator();
		separator_2.setBackground(new Color(65, 105, 225));
		separator_2.setBounds(138, 210, 947, 2);
		frmconhecimento.getContentPane().add(separator_2);

		preencheTabela();

		frmconhecimento.setBackground(new Color(173, 216, 230));
		frmconhecimento.setBounds(100, 100, 1113, 617);
		frmconhecimento.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
